...
class ApiRoutes
{
    ...
    {
        return function () {
            $this->name('sendportal.api.')->prefix('v1')->namespace('\App\Http\Controllers\Api')->group(static function (Router $apiRouter) {
    ...
    {
        return function () {
            $this->name('sendportal.api.webhooks.')->prefix('v1/webhooks')->namespace('\App\Http\Controllers\Api\Webhooks')->group(static function (Router $webhookRouter) {
            ...
            $this->get('v1/ping', '\App\Http\Controllers\Api\PingController@index');
        };
    }
}
